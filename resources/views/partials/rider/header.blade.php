 ...
 <header class="main_header style_2">
     ...
     <div class="header_lower_style_one style_2">
         <div class="container-fulid">
             <div class="header_lower_inner sidemenu_container">
                 <div class="logo-box">
                     <figure class="logo"><a href="{{ route('home')}}"><img src="{{ asset('assets/merchant/images/main-logo.png') }}" alt=""></a>
                     </figure>
                 </div>
                 ...
                 <div class="header_lower_right">
                     ...
                     <a href="{{ route('login')}}" class="popup_btn">log in</a>
                 </div>
             </div>
         </div>
     </div>
     ...
     <div class="sticky_header">
         <div class="container">
             <div class="header-outer-box">
                 <div class="logo-box">
                     <figure class="logo"><a href="index.html"><img src="{{ asset('assets/merchant/images/main-logo.png') }}" alt=""></a>
                     </figure>
                 </div>
                 <div class="menu-area">
                     <nav class="main-menu navbar-expand-md navbar-light">
     ...
     <div class="mobile-menu">
         ...
         <nav class="menu-box">
             <div class="nav-logo"><a href="index.html"><img src="{{ asset('assets/merchant/images/white-logo.png') }}" alt="" title=""></a></div>
